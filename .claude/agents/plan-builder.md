...
description: >-
  ...
  of the six public modules. Returns a step-based plan with public-API,
...
- **Is this a public contract change?** Consumers pin `~> 1.0`. If the change touches the six
  public modules, a documented config key, `document/2`, the `Xcribe.Information` DSL, or the
